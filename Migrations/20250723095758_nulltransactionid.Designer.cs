...
namespace Laundry.Migrations
{
    ...
    [Migration("20250723095758_nulltransactionid")]
    partial class nulltransactionid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laundry.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Laundry.Models.Barcode", b =>
                {
                    b.HasOne("Laundry.Models.BookingClothes", "BookingClothes")
                        .WithOne("Barcode")
                        .HasForeignKey("Laundry.Models.Barcode", "BookingClothesId")
            ...
            modelBuilder.Entity("Laundry.Models.Payment", b =>
                {
                    b.HasOne("Laundry.Models.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("Laundry.Models.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
